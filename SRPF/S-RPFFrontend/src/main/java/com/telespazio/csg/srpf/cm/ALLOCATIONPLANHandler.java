/**
*
* MODULE FILE NAME:	ALLOCATIONPLANHandler.java
*
* MODULE TYPE:		Class definition
*
* FUNCTION:			It manage the ingestion of AllocationPlan
*
...
/**
 * Manage Allocation Plan ingestion
 * 
 * @author Amedeo Bancone
 * @Version 1.0
 *
 */
public class ALLOCATIONPLANHandler implements CM_INotification

{
    ...
    /*
     * Creates a new handler for AllocationPlan requests
     *
     ...
     */
    public ALLOCATIONPLANHandler(final CM_Services cmServ, final TraceManager tracer)
    {
        this.cmServ = cmServ;
     ...
     *
     * @param msgID
     *            ID of the AllocationPlan message to fetch from CM
     */
    public void NewMessageAvailable(final int msgID)
    {
        ...
        int timeout = Integer.parseInt(this.cmIngestorConf.getProperty(CMConstants.CM_ALL_PLAN_TIMEOUT, CMConstants.CM_DEFAULT_TIMEOUT)); // Timeout
                                                                                                                                          // for
                                                                                                                                          // fetching
                                                                                                                                          // ODSTP
                                                                                                                                          // requests
        ...
        String attachmentPath = null; // Path of the attachment of the
                                      // AllocationPlan message
        String allPlanFilePath = null; // The path of the moved file

        try
        {
            CM_Message request = this.cmServ.GetMessage(filter, timeout); // AllPlan
                                                                          // message
                                                                          // from
                                                                          // CM
            ...
            if (attachment != null)
            {
                ...
                allPlanFilePath = moveAttachment(attachmentPath, new Integer(msgID).toString()); // The
                                                                                                 // path
                                                                                                 // of
                                                                                                 // the
                                                                                                 // moved
                ...
                performAlloCationPlan(allPlanFilePath);
     ...
     *            Path of the attachment of the AllocationPlan message
     * @param msgID
     *            ID of the AllocationPlan message fetched from CM
     *
     * @throws IOException
    ...
    private String moveAttachment(final String attachmentPath, final String msgID) throws IOException
    {
        ...
        String workingDir = this.cmIngestorConf.getProperty(CMConstants.CM_ALL_PLAN_WORKING_DIR);

        if (workingDir == null)
        {
            String msg = "No working dir configured for AllocationPlan";
     ...
     * AllocationPlan analysis
     *
     * @param allPlanFilePath
     ...
     */
    private void performAlloCationPlan(final String allPlanFilePath) throws MalformedURLException, SrpfBackendException_Exception
    {
        ...
        wscProxy.manageAllocationPlan(allPlanFilePath); // Result of the
                                                        // AllocationPlan
                                                        // request
