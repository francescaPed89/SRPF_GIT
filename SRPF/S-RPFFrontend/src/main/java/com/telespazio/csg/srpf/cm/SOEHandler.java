/**
*
* MODULE FILE NAME:	SOEHandler.java
*
* MODULE TYPE:		Class definition
*
* FUNCTION:			It manage the ingestion of SOE
*
...
public class SOEHandler implements CM_INotification

{
     ...
     */
    public SOEHandler(final CM_Services cmServ, final TraceManager tracer)
    {
        this.cmServ = cmServ;
    ...
    public void NewMessageAvailable(final int msgID)
    {
        ...
        int timeout = Integer.parseInt(this.cmIngestorConf.getProperty(CMConstants.CM_SOE_TIMEOUT, CMConstants.CM_DEFAULT_TIMEOUT)); // Timeout
                                                                                                                                     // for
                                                                                                                                     // fetching
                                                                                                                                     // ODSTP
                                                                                                                                     // requests
        ...
        String soePlan = null; // The path of the moved file
        ...
        try
        {
            ...
            if (attachment != null)
            {
                ...
                soePlan = moveAttachment(attachmentPath, new Integer(msgID).toString()); // The
                                                                                         // path
                                                                                         // of
                                                                                         // the
                                                                                         // moved
    ...
    private String moveAttachment(final String attachmentPath, final String msgID) throws IOException
    {
        ...
        String workingDir = this.cmIngestorConf.getProperty(CMConstants.CM_SOE_WORKING_DIR);

        if (workingDir == null)
        {

            String msg = "No working dir configured for SOE";
     ...
     */
    private void performSoePlan(final String soePlanPath) throws MalformedURLException, SrpfBackendException_Exception
    {
        ...
        wscProxy.manageSoe(soePlanPath); // Result of the AllocationPlan request
