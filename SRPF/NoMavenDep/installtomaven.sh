...
mvn install:install-file -Dfile=srpfBackendClient-2.2.12p.jar -DgroupId=com.telespazio.csg.srpf -DartifactId=srpfBackendClient -Dversion=2.2.12p -Dpackaging=jar
