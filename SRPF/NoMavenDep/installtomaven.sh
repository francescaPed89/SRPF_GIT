...
mvn install:install-file -Dfile=srpfBackendClient-2.2.9p.jar -DgroupId=com.telespazio.csg.srpf -DartifactId=srpfBackendClient -Dversion=2.2.9p -Dpackaging=jar
